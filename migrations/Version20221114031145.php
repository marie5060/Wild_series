 ...
 */
final class Version20221114031145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, CHANGE synopsis synopsis LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category CHANGE id id INT AUTO_INCREMENT NOT NULL COMMENT \'Primary Key\'');
        ...
        $this->addSql('ALTER TABLE program DROP category_id, CHANGE synopsis synopsis TEXT NOT NULL');
    }
}
